...
function dUdt = odeCarbonateFormation(t, U, K_B, delta, u_max, alpha, beta, K_m, kcat, yCO3, kpptn, Ca)
    B = U(1); E = U(2); S = U(3); S_broken = U(4); C = U(5);
    ...
    dUdt(4) = v;                                               % Urea broken down
    dUdt(5) = yCO3 * abs(v) - kpptn * C * Ca;                  % Carbonate formation
end
